<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-update-pengadaan" method="POST">
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Pemeliharaan" name="pemeliharaan" aria-describedby="sizing-addon2" value="<?php echo $dataPengadaan->pemeliharaan; ?>">
    </div>
