...
class Pengadaan extends AUTH_Controller {
	...
	public function update() {
		...
		// $data['dataPegawai'] = $this->M_pengadaan->select_by_id($id);
		// $data['dataPosisi'] = $this->M_pengadaan->select_all();
		// $data['dataKota'] = $this->M_pengadaan->select_all();
		$data['datapengadaan'] = $this->M_pengadaan->select_by_id($id);
		$data['userdata'] = $this->userdata;
		$data['dataKapal'] = $this->M_pengadaan->select_kapal();
