...
//$_SESSION['tgl'] = $query;
      ...
      //if($_SESSION['tgl'] = $tgl ){
?>
            <center><table class="table-tiket">
            <tr>
                <th>KERETA</th>
                <th>KELAS</th>
                <th>TANGGAL</th>
            ...
            <tr>
                <td align = "center"><?php echo $row['nama_ka']?></td>
                <td align = "center"><?php echo $row['kelas']?></td>
                <td align = "center"><?php echo $row['tgl']?></td>
                <td align = "center"><?php echo $row['jam_berangkat']?></td>
                <td align = "center"><?php echo $row['jam_tiba']?></td>
                <td align = "center"><?php echo $row['asal']?></td>
                <td align = "center"><?php echo $row['ke']?></td>
                <td align = "center"><?php echo $row['harga']?></td>
                <td align = "center"><a href= "tambahtiket.php?idka=<?= $row["id_ka"]?>&kelas=<?=$row["kelas"]?>&asal=<?=$row["asal"]?>&tujuan=<?=$row["ke"]?>&tgl=<?=$row["tgl"]?>"><button class="button-flat-outline">Pilih Tiket</a></button></td>
                </<tr></center></table>;
