...
<head>
    ...
    <title>SmartTrain | Edit Database Ticket</title>
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="tiketEdit.html" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Database Ticket</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
<?php
    ...
    $id = $_REQUEST['id'];
    $idkereta = $_REQUEST['idkereta'];
    $gerbong = $_REQUEST['gerbong'];
    $kursi = $_REQUEST['kursi'];

    $update = "UPDATE tiket SET id_ka = '$idkereta', no_duduk = '$kursi', gerbong = '$gerbong' WHERE id_pembeli = '$id'";    

    if ($id == null || $idkereta == null || $gerbong == null || $kursi == null) {
