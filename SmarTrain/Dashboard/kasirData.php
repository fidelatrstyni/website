...
<head>
    ...
    <title>SmartTrain | Database Kasir</title>
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="kasirData.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Database Kasir</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Database Kasir</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
echo '<tr>
    ...
    <td align = "center">'.$row['uang'].'</td>
    <td align = "center">'.$row['harga'].'</td>
    <td align = "center">'.$row['kembalian'].'</td>
    </<tr>';
}
echo '
</tbody>
