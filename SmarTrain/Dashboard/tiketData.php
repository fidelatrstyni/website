...
<head>
    ...
    <title>SmartTrain | Database Ticket</title>
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="tiketData.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Database Ticket</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Database Ticket</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
echo '<tr>
    ...
    <td align = "center">'.$row['id_ka'].'</td>
    <td align = "center">'.$row['gerbong'].'</td>
    <td align = "center">'.$row['no_duduk'].'</td>
    <td align = "center"><a href="tiketEdit.html"> Edit </a></td>
    </<tr>';
}
echo '
</tbody>
