...
<head>
    ...
    <title>SmartTrain | Database User</title>
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="userData.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Database User</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Database User</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
echo '<tr>
    ...
    <td align = "center"><a href="userEdit.html"> Edit </a></td>
    </<tr>';
}
echo '
</tbody>
