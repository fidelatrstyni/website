...
<head>
    ...
    <title>SmartTrain | Edit Database User</title>
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="userEdit.html" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Database User</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
<?php
    ...
    $update = "UPDATE user SET name = '$name', username = '$user', password = '$password' WHERE id = '$id'";    

    if ($id == null || $name == null || $user == null || $password == null) {
