...
<head>
    ...
    <title>SmartTrain | Database Train</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Database Train</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
echo '<tr>
    ...
    <td align = "center"><a href="keretaEdit.html"> Edit </a></td>
    </<tr>';
}
echo '
</tbody>
