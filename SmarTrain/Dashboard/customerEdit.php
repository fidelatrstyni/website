...
<head>
    ...
    <title>SmartTrain | Edit Database Customer</title>
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="customerEdit.html" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="kasirDataa.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Database Kasir</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Database Customer</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
...
<?php
    ...
    $update = "UPDATE pembeli SET id = '$id', nama = '$nama', ktp = '$ktp', no_tlp = '$nohp', jkelamin = '$jkelamin', tgl = '$tgl', kelas = '$kelas', asal = '$asal', tujuan = '$tujuan' WHERE id_pembeli = '$idcustomer'";    

    if ($id == null || $idcustomer == null || $nama == null || $ktp == null || $nohp == null || $jkelamin == null || $tgl == null || $kelas == null || $asal == null || $tujuan == null) {
