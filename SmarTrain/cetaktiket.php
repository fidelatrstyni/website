	...
	<div class="container-css">
		...
		<ul class="pull-left">
			...
			<ul class="pull-right-css menu">
				<li style="margin-top: 10px;"><a class="class-a">HOME</a></li>
				<li style="margin-top: 10px;"><a class="class-a"></a></li>
				<li style="margin-top: 10px;"><a class="class-a"></a></li>
				<li style="margin-top: 10px;"><a class="class-a"></a></li>
				<div class="li-right-cs">
...
$search = "SELECT * FROM pembeli WHERE ktp = '$ktp'";
...
//$_SESSION['tgl'] = $query;
      ...
      //if($_SESSION['tgl'] = $tgl ){
            ...
            echo '<tr>
				...
				<td align = "center">'.$row['no_duduk'].'</td>
				<td align = "center">'.$row['gerbong'].'</td>
                </<tr></center></table>';
            }
	...
	<div class="footer">
		<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<br><br>
					<p style="margin-left: 450px; font-size: 20px;color:white;">&copy;Copyright SMART TRAIN 2019
						Allright
						Reserved.</p>
				</div>
			</div>
