                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('electreCari')?>" method="post">
                                ...
                                <select name="tema" class="browser-default custom-select">
                                    <option value="" <?= ($tema == '' ? 'selected' : '')?>>Semua</option>
                                    <option value="Gedung" <?= ($tema == 'Gedung' ? 'selected' : '')?>>Gedung</option>
                                    <option value="Taman" <?= ($tema == 'Taman' ? 'selected' : '')?>>Taman</option>
                                    <option value="Pantai" <?= ($tema == 'Pantai' ? 'selected' : '')?>>Pantai</option>
                                    <option value="Hutan" <?= ($tema == 'Hutan' ? 'selected' : '')?>>Hutan</option>
                                </select>
                                ...
                                <select name="lokasi" class="browser-default custom-select">
                                    ...
                                    <option value="Malang" <?= ($lokasi == 'Malang' ? 'selected' : '')?>>Malang</option>
                                    <option value="Sidoarjo" <?= ($lokasi == 'Sidoarjo' ? 'selected' : '')?>>Sidoarjo
                                    </option>
                                    <option value="Surabaya" <?= ($lokasi == 'Surabaya' ? 'selected' : '')?>>Surabaya
                                    </option>
                                    <option value="Batu" <?= ($lokasi == 'Batu' ? 'selected' : '')?>>Batu</option>
                                </select>
                                </p>
                ...
                <div class="col-lg-12">
					...
					?>
							...
							?>
                                        ...
                                        // for ($i=0; $i<sizeof($perkalian); $i++) {
                                        //     echo "<tr>";
                                        //     for ($j=0; $j<sizeof($perkalian[$i]); $j++) {
                                        //         echo "<td>". round($perkalian[$j], 4) ."</td>";
                                        //     }
                                        //     echo "</tr>";
                                        // }
                                        // echo "</table>";
