                    ...
                    <div class="card text-center">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?= base_url('Electre/kriteria') ?>">Kriteria</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <button type="button" style="float: right;"
                                        onClick="location.href='<?=base_url('')?>/Electre/formTambahKriteria'"
                            ...
                            <table id="example" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a
                                                href="<?= base_url('Electre/formEditKriteria/' . $value['id_kriteria'])?>">
                                                <i class="fa fa-edit fa-fw"></i>
                                                <a href=<?= base_url('Electre/deleteKriteria/' . $value['id_kriteria'] )?>
                                                    class="btn-hapus">
