                        ...
                        <div class="card-header">
                            <div class="col-md-2">
                                ...
                                <button type="button" style="float: right;"
                                    onClick="location.href='<?=base_url('')?>/Paket/formTambah'"
                            ...
                            <table id="example" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $value['katering']?></td>
                                        <td><?= $value['invitation']?></td>
                                        <td><?= $value['foto']?></td>
                                        <?php if($userProfil[0]['roles'] == '2') {?>
                                        <td align="center">
                                            <a href="<?= base_url('Paket/edit/' . $value['id_paket'])?>"
                                                class="btn-edit">
                                                <i class="fa fa-edit fa-fw"></i>
                                                <!--a href="#" data-id="" class="btn-delete">
                                                    <i class="fa fa-trash fa-fw btn-delete"></i-->
                                                <a href="<?= base_url('Paket/hapus/' . $value['id_paket'])?>"
                                                    class="btn-hapus">
