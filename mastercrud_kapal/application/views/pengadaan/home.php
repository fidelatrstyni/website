      ...
      <?php
          ...
          foreach ($dataPengadaan as $pengadaan) {
            ...
            <tr>
              ...
              <td><?php echo $pengadaan->aktor; ?></td>
              <?php if($userdata->status == 'direktur') {
              } else {
              ?>
              <td class="text-center" style="min-width:230px;">
                ...
                <button class="btn btn-danger konfirmasiHapus-pengadaan" data-id="<?php echo $pengadaan->id_pengadaan; ?>" data-toggle="modal" data-target="#konfirmasiHapus"><i class="glyphicon glyphicon-remove-sign"></i> Delete</button>
              </td>
              <?php } ?>
            </tr>
            <?php
...
<?php show_my_confirm('konfirmasiHapus', 'hapus-dataPengadaan', 'Hapus Data Ini?', 'Ya, Hapus Data Ini'); ?>
<?php
