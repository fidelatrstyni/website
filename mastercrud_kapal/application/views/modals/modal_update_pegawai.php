<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Update Data Pegawai</h3>
      <form method="POST" id="form-update-pegawai">
        <input type="hidden" name="id_crew" value="<?php echo $dataPegawai->id_crew; ?>">
        ...
        <div class="input-group form-group">
          ...
          <select name="jabatan" class="form-control select2" aria-describedby="sizing-addon2">
            ...
            <option <?php if ($dataPegawai->jabatan == 'Mualim') { echo 'selected'; }?> value="Mualim">Mualim</option>
            <option <?php if ($dataPegawai->jabatan == 'Kemudi') { echo 'selected'; }?> value="Kemudi">Kemudi</option>
            <option <?php if ($dataPegawai->jabatan == 'Pelayan') { echo 'selected'; }?> value="Pelayan">Pelayan</option>
            <option <?php if ($dataPegawai->jabatan == 'Masinis') { echo 'selected'; }?> value="Masinis">Masinis</option>
            <option <?php if ($dataPegawai->jabatan == 'Electrician') { echo 'selected'; }?> value="Electrician">Electrician</option>
          </select>
        </div>
        <div class="input-group form-group">
          <span class="input-group-addon" id="sizing-addon2">
          ...
          <input type="text" class="form-control" placeholder="Departemen" name="departemen" aria-describedby="sizing-addon2" value="<?php echo $dataPegawai->departemen; ?>">
        </div>
