          ...
          <form class="form-horizontal" action="<?php echo base_url('Profile/update') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select name="level" class="form-control" aria-describedby="sizing-addon2">
                <option  <?php if ($userdata->level == 1) { echo 'selected'; }?> value="1" > 1 </option>
                <option <?php if ($userdata->level == 2) { echo 'selected'; }?> value="2" > 2 </option>
                <option <?php if ($userdata->level == 3) { echo 'selected'; }?> value="3" > 3 </option>
              </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <select name="status" class="form-control" aria-describedby="sizing-addon2">
                <option  <?php if ($userdata->status == 'superadmin' && $userdata->level == 1) { echo 'selected'; }?> value="superadmin" > Superadmin </option>
                <option <?php if ($userdata->status == 'admin' && $userdata->level == 2) { echo 'selected'; }?> value="admin" > Admin </option>
                <option <?php if ($userdata->status == 'direktur' && $userdata->level == 3) { echo 'selected'; }?> value="direktur" > Direktur </option>
              </select>
              </div>
            </div>
            <div class="form-group">
