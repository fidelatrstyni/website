...
class Inventory extends AUTH_Controller {
	...
	public function prosesTambah() {
		$this->form_validation->set_rules('stok_barang', 'Stock Barang', 'trim|required');
		...
		if ($this->form_validation->run() == TRUE) {
			$result = $this->M_inventory->insert_inventory($data);
	...
	public function update() {
		...
		$data['dataKapal'] = $this->M_inventory->select_kapal();
		$data['userdata'] = $this->userdata;
	...
	public function prosesUpdate() {
		$this->form_validation->set_rules('nama_barang', 'Nama Barng', 'trim|required');
